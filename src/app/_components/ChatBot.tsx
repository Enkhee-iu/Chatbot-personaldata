      ...
      <div className="p-4  bg-gray-50 flex justify-between items-center">
        ...
        {messages.length > 0 && (
          <button 
            ...
            className="cursor-pointer text-xs text-red-500 hover:text-red-700 px-2 py-1 rounded border border-transparent hover:border-red-200 transition-colors"
          >
            цэвэрлэх
          </button>
        )}
      ...
      <div className="p-4 bg-gray-50">
        <form onSubmit={sendMessage} className="flex gap-2">
          ...
          <button
            ...
            className="bg-blue-600 cursor-pointer text-white px-6 py-2 rounded-xl hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors"
          >
            Илгээх
          </button>
        </form>
